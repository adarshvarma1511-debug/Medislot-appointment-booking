...
async function runTests() {
  console.log("=================================================================")
  console.log("    MEDISLOT GOOGLE OAUTH & PATIENT AUTH VERIFICATION SUITE      ")
  console.log("=================================================================")
  ...
  try {
    ...
    if (redirectLocation && redirectLocation.includes("accounts.google.com")) {
      assert(
        redirectLocation.startsWith("https://accounts.google.com/o/oauth2/v2/auth"),
    ...
    assert(doctorUser && doctorUser.role === "doctor", "Doctor account found in DB")
    assert(
    ...
    const loginPageRes = await fetch(`${BASE_URL}/api/auth/google/callback?error=test_ui_error`, {
      redirect: "manual",
    })
    ...
    console.log("\n=================================================================")
    console.log(`🎉 ALL ${passed} VERIFICATION TESTS PASSED SUCCESSFULLY! (${passed}/${passed})`)
    console.log("=================================================================")
  } catch (err) {
